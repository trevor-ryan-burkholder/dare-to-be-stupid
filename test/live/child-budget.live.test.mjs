...
describe('the in-flight budget bound reaches a real child', { skip: ARMED ? false : 'MEESEEKS_LIVE is not set' }, () => {
  it('lets an ordinary child through when the allowance is ample', { timeout: LIVE_TIMEOUT }, async () => {
  ...
  it('stops a child whose allowance is spent, and does not report a verdict', { timeout: LIVE_TIMEOUT }, async () => {
  ...
  it('accepts the undocumented turn cap, or says plainly that it does not', { timeout: LIVE_TIMEOUT }, async () => {
